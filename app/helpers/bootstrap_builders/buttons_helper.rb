module BootstrapBuilders::ButtonsHelper
  ...
  def bb_edit_btn(*args)
    ...
    button = BootstrapBuilders::Button.new({icon: "wrench", context: self, can_type: :edit}.merge(args))
  ...
  def bb_destroy_btn(*args)
    ...
    button = BootstrapBuilders::Button.new({icon: "trash-alt", context: self, can_type: :destroy, method: :delete}.merge(args))
  ...
  def bb_new_btn(*args)
    ...
    button = BootstrapBuilders::Button.new({icon: "plus", context: self, can_type: :new}.merge(args))
  ...
  def bb_index_btn(*args)
    ...
    button = BootstrapBuilders::Button.new({icon: "table", context: self, can_type: :index}.merge(args))
  ...
  def bb_show_btn(*args)
    ...
    button = BootstrapBuilders::Button.new({icon: "square", context: self, can_type: :show}.merge(args))
